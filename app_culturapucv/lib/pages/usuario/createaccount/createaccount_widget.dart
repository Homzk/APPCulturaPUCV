                                  ...
                                  children: [
                                              ...
                                              child: Padding(
                                                padding: EdgeInsetsDirectional
                                                    .fromSTEB(
                                                        0.0, 12.0, 0.0, 24.0),
                                                child: Text(
                                                  'Se presenta para ingresar a los eventos y accede a distintas oportunidades',
                                                  textAlign: TextAlign.center,
                                                  maxLines: 2,
                                    ...
                                    Padding(
                                      ...
                                      child: Container(
                                        ...
                                        child: TextFormField(
                                          ...
                                          validator: _model
                                              .emailPhoneTextControllerValidator
                                              .asValidator(context),
                                        ),
                                      ),
                                    ),
                                    ...
                                    Padding(
                                      ...
                                      child: FFButtonWidget(
                                        onPressed: ((_model.emailPhoneTextController
                                                            .text ==
                                                        null ||
                                                    _model.emailPhoneTextController
                                                            .text ==
                                            ...
                                            : () async {
                                                ...
                                                if (functions.validateRut(functions
                                                            .formatedRut(_model
                                                                .rutTextController
                                                                .text)) !=
                                                        null &&
                                                    functions.validateRut(functions
                                                            .formatedRut(_model
                                                                .rutTextController
                                                                .text)) !=
                                                        '') {
                                                      ...
                                                      builder:
                                                        ...
                                                        return AlertDialog(
                                                          title: Text(
                                                              'RUT ya Registrado.'),
                                                          content: Text(
                                                              'el RUT ingresado ya está asociado a una cuenta existente.'),
                                                          actions: [
                                                            TextButton(
                                                              onPressed: () =>
                                                                  Navigator.pop(
